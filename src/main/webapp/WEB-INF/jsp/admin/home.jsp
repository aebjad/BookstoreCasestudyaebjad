...
<br/>
    ...
    <div style="float: left; padding-right: 10px"><a href="/newBook" class="btn btn-warning" style="width: 200px" role="button"> Add new book </a></div>
    </br>
<form method="GET" action="/admin/bookList">
    <div ><button type="submit" class="btn btn-warning" style="width: 200px" role="button"> Display All Books </button></div>
</form>
    <br/>
    </br>
